...
function closeNav() {
  ...
  <div class="container-fluid srch">
    <form class="navbar-form" method="post" name="form1">
        ...
        <input class="form-control" type="text" name="search" placeholder="search books.." required=""><button style="background-color:#ffc107; " type="submit" name="submit" class="btn btn-default">
    ...
    <form class="navbar-form" method="post" name="form1">
        ...
        <input class="form-control" type="text" name="bid" placeholder="Enter Book Id" required=""><button style="background-color:#ffc107; " type="submit" name="submit1" class="btn btn-default">
          Delete
        </button>
