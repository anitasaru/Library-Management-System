...
function closeNav() {
 ...
 <form class="navbar-form" method="post" name="form1">
        ...
        <input class="form-control" type="text" name="uname" placeholder="Enter Admin Username" required="">
        <button style="background-color:#ffc107; " type="submit" name="submit1" class="btn btn-default">
          Delete
        </button>
	...
	<?php
			...
			$res=mysqli_query($db,"SELECT first,last,uname,email FROM `admin`;");
    ...
    {
        mysqli_query($db,"DELETE from `admin` where uname = '$_POST[uname]'; ");
        ?>
